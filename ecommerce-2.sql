...
--
-- Host: localhost
-- Generation Time: Mar 11, 2018 at 05:30 PM
...
INSERT INTO `cart` (`p_id`, `ip_add`, `qty`, `customer_email`) VALUES
(0, '', 0, 'mno@123.com'),
(1, '::1', 0, ''),
(2, '::1', 0, ''),
(3, '::1', 0, ''),
...
--
ALTER TABLE `products`
  MODIFY `product_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;COMMIT;
